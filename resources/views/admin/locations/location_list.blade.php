                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb float-right">
                                                @if(isset($PlaceModuleRights) && $PlaceModuleRights->is_create==1)
                                                <a href="{{route('add.location')}}" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-plus-circle"></i>Add New
                                                </a>
                                                @endif
                                                @if(isset($PlaceModuleRights) && $PlaceModuleRights->is_export==1)
    ...
    $(document).ready(function () {
        ...
        $('.clear').click(function refreshData() {
         ...
         $('.export').click(function refreshData() {
            ...
            var url='{{route('export.location')}}?data='+JSON.stringify(param);
