@extends('layouts.app')
@section('title',(isset($editData))?'Edit Location':'Add Location')
@section('content')
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <h4>{{(isset($editData))?'Edit Location':'Add Location'}}</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                ...
                                <div class="card-block">
                                    <form id="main" class="need-validation" 
                                          method="post" 
                                          action=" {{ (isset($editData)) ? route('update.location',base64_encode($editData->id)) : route('store.location')}}" 
                                    ...
                                    >
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                >
                                                    ...
                                                    <option value="{{$row->name}}" 
                                                      @selected(($row->name==(isset($editData->place_type)?$editData->place_type:'')))>
                                                      {{$row->name}}
                                                    </option>
                                        ...
                                        <a href="{{route('list.location')}}"  class="btn btn-danger">CANCEL</a>
                                    </form>
                                </div>
                            </div>
                        </div>
