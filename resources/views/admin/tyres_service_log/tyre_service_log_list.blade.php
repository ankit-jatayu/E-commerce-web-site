...
?>
@extends('layouts.app')
@section('title','Tyre Service Log')
@section('content')
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        ...
                                        @if(isset($TyreServiceLogModuleRights) && $TyreServiceLogModuleRights->is_create==1)

                                        <a href="{{route('tyre.service.log.add')}}" class="btn waves-effect waves-light btn-primary float-right"><i class="icofont icofont-plus"></i>Add New </a>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        var table  = $('#dt-ajax-array').DataTable({
            ...
            "ajax": {
                url: "{{route('tyre.service.log.paginate')}}",
                type: "POST",
                data: function(d) {
                    d._token = '{{csrf_token()}}';
    ...
    function deleteRecord(id){
       ...
       if(confirm("Are you sure you want to Delete Detail ?")){
        $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route('delete.tyre.service.log') }}',
