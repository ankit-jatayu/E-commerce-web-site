                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb float-right ">
                                        @if(isset($PartyModuleRights) && $PartyModuleRights->is_create==1)
                                        ...
                                        @if(isset($PartyModuleRights) && $PartyModuleRights->is_export==1)
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-lg-6 col-md-3">
                    ...
                    <select name="party_type_id" id="party_type_id" class="form-control select2" style="width: 100%;" required multiple>
                        <option value="">CHOOSE PARTY TYPE</option>       
                        @if(!empty($partyTypes))
                        @foreach($partyTypes as $k =>$ledgerType)   
...
<script>
    $(document).ready(function () {
        ...
        var table  = $('#dt-ajax-array').DataTable({
            ...
            "ajax": {
                url: "{{route('party.paginate')}}",
                type: "POST",
                data: function(d) {
                    d._token = '{{csrf_token()}}';
                    // d.party_id = $('#party_id').val();
                    d.party_type_id = $('#party_type_id').val();
        ...
        $('.export').click(function refreshData() {
            var param={
                ...
                party_type_id : $('#party_type_id').val(),
