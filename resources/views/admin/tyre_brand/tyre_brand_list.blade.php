                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                       {{--  <button type="button" class="btn btn-info float-right ml-1" data-toggle="modal" data-target="#filterTableModal" title="click here to filter" >
                                        ...
                                        @if(isset($TyresBrandModuleRights) && $TyresBrandModuleRights->is_create==1)

                                        <a href="{{route('tyre.brand.add')}}" class="btn waves-effect waves-light btn-primary float-right"><i class="icofont icofont-plus"></i>Add New </a>
                                        @endif
                                    </div>
                                </div>
                            </div>
