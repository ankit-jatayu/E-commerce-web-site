@extends('layouts.app')
@section('title',(isset($editData))?'Edit Tyres Brand':'Add Tyres Brand')
@section('content')
<?php 
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    action=" {{ (isset($editData)) ? route('tyre.brand.update',base64_encode($editData->id)) : route('tyre.brand.store')}}"
                            ...
                            <a href="{{route('tyre.brand.list')}}"  class="btn btn-danger">CANCEL</a>
                        </form>
                    </div>
                </div>
            </div>
