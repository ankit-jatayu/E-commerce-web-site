                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <!-- @if(isset($MaterialModuleRights) && $MaterialModuleRights->is_export==1)
                                                ...
                                                @endif -->
                                                @if(isset($MaterialModuleRights) && $MaterialModuleRights->is_create==1)
                                                <a href="{{route('product.add')}}" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i>Add New </a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
        ...
        if(confirm('are you sure want to delete this record?')){
            $.ajax({
                ...
                success: function (response) {
                    if(response==1){
                         $("#alert-msg-block").html('<div class="alert alert-danger background-danger" style="width: 100%"><strong> Product Deleted !!</strong></div>');
                    }else{
                        $("#alert-msg-block").html('<div class="alert alert-danger background-danger" style="width: 100%"><strong> Product Not Deleted !!</strong></div>');
                    }
