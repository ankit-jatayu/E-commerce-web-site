                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        ...
                                        @if(isset($TyreAsignsModuleRights) && $TyreAsignsModuleRights->is_create==1)
                                        <a href="{{route('tyres.assigns.add')}}" class="btn waves-effect waves-light btn-primary float-right"><i class="icofont icofont-plus"></i>Add New</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
      ...
      function deleteRecord(id){
       ...
       if(confirm("Are you sure you want to Delete Detail ?")){
        $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route('delete.tyres.assigns') }}',
